...
<head>
  ...
  <link rel='stylesheet' type="text/css" href='{theme_url}/jscripts/jquery.lightbox-0.5.css' />
  ...
  <script type="text/javascript" src="{theme_url}/jscripts/jquery.lightbox-0.5.js"></script>
   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Guest Book -->
        <h1 class="pagetitle"><?php if (!empty($album_title)) echo $album_title; else echo "Gallery" ?></h1>
		
		<?php if (!empty($photo)) { ?>
		<div class="column1-unit">
			<p><?php if (!empty($album_desc)) echo $album_desc; ?>
				<div id="gallery">
					<ol>
						<?php foreach($photo as $row=>$value) { ?>
							<li><a href="<?php echo $value['photo_image'] ?>" title="<?php echo $value['photo_desc'] ?>"><img src="<?php echo $value['photo_thumbnail'] ?>"></a></li>
						<?php } ?>
					</ol>
				</div>
			</p>
			<p class="details">
				...
				<?php echo anchor(reduce_double_slashes(config_item('base_url').config_item('index_page').'/gallery/'), '&laquo; Kembali ke daftar gallery'); ?>
			</p>
		</div>
		<?php } ?>
      </div>
