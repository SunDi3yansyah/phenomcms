...
<head>
  ...
  <script type="text/javascript" src="{theme_url}/jscripts/jquery.cycle.all.min.js"></script>
  ...
  <!-- News Slide -->
  <style type="text/css">
  	#navigasi { margin: 5px; margin-bottom: 10px; }
	#navigasi a { margin: 5px; padding: 3px 5px; border: 1px solid #ccc; background: #ddd; text-decoration: none }
	#navigasi a.activeSlide { background: #bbb }
	#navigasi a:focus { outline: none; }
	#slidenews { margin: 0px; padding: 0px; }
  </style>
   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <h1 class="pagetitle">Hot News</h1>
        <!-- Content unit - One column -->
		<div id="slidenews">
			<?php foreach ($recent_posts as $row=>$value) { ?>
			<div class="column1-unit">
			  <h1><?php echo $value['posting_title']; ?></h1>                            
			  <h3><?php echo $value['posting_date']; ?></h3>
			  <p>
			  <?php if (!empty($value['posting_image'])) { ?>
			  <img src="<?php echo $value['posting_image']; ?>" alt="Image description" title="Image title" />
			  <?php } ?>
			  <?php echo $value['posting_middle_content']; ?> <a href="<?php echo $value['posting_url']; ?>">Read more</a></p>
			</div>
			<?php } ?>
		</div>
		<div id="navigasi"></div>
