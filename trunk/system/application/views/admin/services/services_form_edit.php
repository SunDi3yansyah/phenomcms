...
<h2>Edit Services</h2>
<br />
<form enctype="multipart/form-data" method="post" name="phenomcms" action="<?php echo config_item('base_url').config_item('index_page') ?>/cpm/services_edit/">
...
<tr>
	...
	<th>:</th>
	<td>
	<input name="mrc_seo" type="text" size="120" value="{multiple record mrc_seo}">
	</td>
</tr>
<tr>
...
<tr>
	<th width="100px">Status Comments</th>
	<th>:</th>
	<td>
	<?php
	...
	?>
	<input name="mrc_comment_status" type="radio" value="1" <?php echo $checked1?>> Active
	<input name="mrc_comment_status" type="radio" value="0" <?php echo $checked0?>> Non Active
	</td>
</tr>
<tr>
	<td colspan="3">
