...
<a href="{base_url}cpm/directory/posting/">Members</a> &gt;  
...
<form enctype="multipart/form-data" method="post" name="phenomcms" action="<?php echo config_item('base_url').config_item('index_page') ?>/cpm/members_insert/">
...
<tr>
	...
	<th>:</th>
	<td>
	<input name="mrc_firstname" type="text" size="30">
	</td>
</tr>
<tr>
	<th>Last name</th>
	<th>:</th>
	<td>
	<input name="mrc_lastname" type="text" size="30">
	</td>
</tr>
...
<tr>
	...
	<th>:</th>
	<td>
	<input name="mrc_title" type="text" size="50">
	</td>
</tr>
<tr>
	<th>Website</th>
	<th>:</th>
	<td>
	<input name="mrc_website" type="text" size="50">
	</td>
</tr>
<tr>
	<th>SEO Keyords</th>
	<th>:</th>
	<td>
	<input name="mrc_seo" type="text" size="50">
	</td>
</tr>
<tr>
	<th>Email</th>
	<th>:</th>
	<td>
	<input name="mrc_email" type="text" size="50">
	</td>
</tr>
...
<tr>
	...
	<th>:</th>
	<td>
	<input name="mrc_telephone" type="text" size="50">
	</td>
</tr>
<tr>
	<th>Address</th>
	<th>:</th>
	<td>
	<input name="mrc_address" type="text" size="100">
	</td>
</tr>
...
<tr>
	...
	<th>:</th>
	<td>
	<input name="mrc_company" type="text" size="100">
	</td>
</tr>
