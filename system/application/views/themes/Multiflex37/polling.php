...
<head>
  ...
  <!--[if IE]><script language="javascript" type="text/javascript" src="{theme_url}/jscripts/chart/excanvas.js"></script><![endif]-->
  
  <link rel="stylesheet" type="text/css" href="{theme_url}/jscripts/chart/jquery.jqplot.css" />
  <link type="text/css" href="{theme_url}/jscripts/chart/examples/jquery-ui/css/ui-lightness/jquery-ui-1.8.1.custom.css" rel="Stylesheet" />	
  
  <!-- jQuery -->
  <script type="text/javascript" src="{theme_url}/jscripts/jquery-1.4.3.min.js"></script>
  <script type="text/javascript" src="{theme_url}/jscripts/chart/examples/jquery-ui/js/jquery-ui-1.8.1.custom.min.js"></script>

  <!-- BEGIN: load jqplot -->
  <script language="javascript" type="text/javascript" src="{theme_url}/jscripts/chart/jquery.jqplot.js"></script>
  <script language="javascript" type="text/javascript" src="{theme_url}/jscripts/chart/plugins/jqplot.pieRenderer.js"></script>
  <script language="javascript" type="text/javascript" src="{theme_url}/jscripts/chart/plugins/jqplot.pointLabels.js"></script>
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <div class="column1-unit">
			<h3><div id="chart1" style="margin-top:0px; width:420px; height:350px;"></div></h3>
			<h1>Polling</h1>
