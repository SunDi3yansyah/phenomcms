    ...
    <div class="main">
      ...
      <div class="main-content">
		...
		<?php if (!empty($album_list)) { ?>
			<?php foreach($album_list as $row=>$value) { ?>
				<div class="column1-unit">
					<p>
						<?php if (!empty($value['album_thumbnail'])) { ?>
							<img src="<?php echo $value['album_thumbnail']; ?>">
						<?php } ?>
						<?php echo $value['album_desc']; ?>
					</p>
					<p class="details"><div style="overflow: hidden; padding: 5px; background: #eeeeee; border: 1px solid #dddddd; margin-bottom: 5px;"><a href="<?php echo $value['album_url']; ?>" style="background: url({theme_url}/img/page.gif) no-repeat; padding-left: 20px; display: block; height: 16px; float: left;">Lihat Album</a><span style="margin-left: 15px; background: url({theme_url}/img/clock.gif) no-repeat; padding-left: 20px; height: 20px; display: block; float: left;"><?php echo $value['album_date']; ?></span></div></p>
