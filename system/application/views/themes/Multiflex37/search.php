   ...
   <!-- For alternative headers START PASTE here -->
    ...
    <div class="main">
      ...
      <div class="main-content">
        ...
        <!-- Pagetitle -->
        <h1 class="pagetitle">Hasil Pencarian</h1>
        ...
        <div class="column1-unit">
			<p>
				<ul>
					...
					<li>
					<a href="<?php echo $value['posting_link']; ?>"><?php echo $value['posting_title']; ?></a>
					<p style="font-size: 8pt;"><?php echo $value['posting_content']; ?></p>
					</li>
					<?php } 
					}
					else {
