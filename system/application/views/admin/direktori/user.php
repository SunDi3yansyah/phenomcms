  <div id="subcontent-wide">
    <div class="subcontent-element">
			...
			<div class="listview_common">
			<a href="<?php echo reduce_double_slashes(config_item('base_url').'/cpm/user/') ?>">
			<img src="<?php echo reduce_double_slashes(config_item('base_url').'/files/admin/images/user.gif') ?>" alt="">
			Daftar User
			</a>
			<a href="<?php echo reduce_double_slashes(config_item('base_url').'/cpm/password/') ?>">
			<img src="<?php echo reduce_double_slashes(config_item('base_url').'/files/admin/images/password.png') ?>" alt="">
			Setting Password
			</a>
			</div>
